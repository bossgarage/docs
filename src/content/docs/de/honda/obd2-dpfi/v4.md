...
Der Honduino OBD2 DPFI ist ein Aftermarket-Motorsteuergerät (ECU), das speziell für Honda-Fahrzeuge mit DPFI-Systemen (Dual Point Fuel Injection) entwickelt wurde. Diese Anleitung führt Sie durch die vollständige Konfiguration, Kalibrierung und erweiterte Einstellung der Version V4 dieser ECU.

Diese Dokumentation umfasst:

- Ersteinrichtung und Installation der erforderlichen Software
- Konfiguration der grundlegenden ECU-Parameter (Triggerrad, Zündung, Einspritzung)
- Anschluss und Kalibrierung der ECU mit Ihrem Fahrzeug
- Einrichtung erweiterter Funktionen wie O2-Breitbandsensor, Launchcontrol und Ladedruckregelung
- Referenz-Pinbelegungsdiagramme für den Anschluss von Ein- und Ausgängen

Ob Sie von der Original-ECU aufrüsten oder eine bestehende Aftermarket-Einheit ersetzen, diese Anleitung bietet Schritt-für-Schritt-Anweisungen, um Ihren Honda mit optimaler Leistung unter Verwendung des Honduino OBD2 DPFI V4 zu betreiben.

## Vor dem Anschließen der ECU an das Fahrzeug
