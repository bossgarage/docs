...
1. Ajuste a marcha lenta quando o motor estiver em sua temperatura normal de operação.
...
3. **Multiplicador de Marcha Lenta em Aquecimento** ajusta o valor com base na configuração de marcha lenta em malha aberta.
![Menu de controle de marcha lenta](/images/honda/obd2-dpfi/v5/image48.png)
...
4. **Marcha lenta em malha fechada** ajusta a marcha lenta através de um algoritmo PID.
![Menu de controle de marcha lenta](/images/honda/obd2-dpfi/v5/image48.png)
...
5. **Ponto de ignição de marcha lenta em malha fechada** ajusta a marcha lenta avançando ou retardando o ponto de ignição.
